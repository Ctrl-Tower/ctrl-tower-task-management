...
export function ArchiveList({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-slate-100">Archive</h1>
            ...
            <div key={t.id} className="card-surface flex items-center gap-3 p-3">
              <div className="min-w-0 flex-1">
                <div className="mb-1 flex items-center gap-2">
                  <span className="rounded border border-slate-600 px-1.5 py-px text-[10px] font-medium uppercase tracking-wide text-slate-300">
              ...
              <button
                ...
                className="btn-ghost shrink-0 border border-slate-700 text-xs"
              >
